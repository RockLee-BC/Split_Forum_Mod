<?php
/**********************************************************************************
* ManageSplitForum..spanish_latin.php - Latin Spanish language file of the Split Forum Mod
***********************************************************************************
...
$txt['subforums_list_desc'] = 'Editar su subforo aqui. Para crear un nuevo sub-foro, haga clic en el bot&oacute;n A&ntilde;adir subforo.';
$txt['subforums_list_header'] = 'Administrar subforo';
$txt['subforums_list_forumid'] = 'Subforo identificaci&oacute;n(ID)';
...
$txt['subforum_modify_dontchange'] = 'NO cambiar esta configuraci&oacute;n a menos que sepa lo que est&aacute; haciendo!!!';
...
$txt['subforum_settings_topmenu'] = 'Mostrar sitios amigos en el men&uacute; superior';
...
$txt['subforum_error_no_url'] = 'Sin una direcci&oacute;n web especificado para este foro.';
$txt['subforum_error_dup_id'] = 'La identificaci&oacute;n(ID) del subforo especificado ya se ha utilizado. Por favor seleccione otro n&uacute;mero de identificaci&oacute;n(ID).';

$txt['no_pack_in_subforum'] = 'No se puede acceder a la p&aacute;gina de paquetes a través de un subforo!';

$txt['subforum_mod_update'] = 'Foro versi&oacute;n dividida Mod %s est&aacute; disponible para su descarga!';
